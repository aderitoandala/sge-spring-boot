...
public class AproveitamentoController {
	...
	public ResponseEntity<AproveitamentoResponseDTO> listarPorAlunoESemestre(@PathVariable Long alunoId,
	...
	public ResponseEntity<AproveitamentoResponseDTO> actualizar(@PathVariable Long id,
			@RequestBody @Valid AproveitamentoRequestDTO dto) {
